...
| `major` | a **tripwire** — engine primitive, `packages/engine/src/rules.ts`/`apps/demo/src/pages/Rules.tsx`/`DECISIONS.md`, or changes what a card *does* | **Blaine only** (`build-now`) |
