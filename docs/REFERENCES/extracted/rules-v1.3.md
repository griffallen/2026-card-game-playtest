...
- **Politician** — At the end of each round, count your Politicians. If you control the most units in the Neutral zone, you gain 1 Influence per Politician; if you control the most units in your enemy's Home zone, you gain 2 Influence per Politician. Both can apply — holding both majorities is worth 3 Influence per Politician. "Control the most" means strictly more of your units than the opponent's in that zone; a tie is not a majority.
