...
export function AuditArchive() {
  return (
    <div className="mx-auto max-w-3xl px-6 pb-24 pt-10 text-[15px]">
      <p className="text-xs uppercase tracking-[0.2em] text-dim">New Game · Design Audit · HISTORICAL ARCHIVE · frozen 2026-07-09</p>
      <h1 className="mt-2 font-display text-4xl font-bold text-parchment">Design & Engine Audit — the original</h1>

      <Card>
        <b className="font-display text-parchment">🗄 This is a historical record, preserved as written.</b>
        <p className="mt-2 text-[14px] leading-relaxed text-body/90">
          This page grew layer by layer from the first prototype audit (July 7, rules v1.2-proto) through
          the turn-structure rework (v2.0) and the canon sprint (session 006) — so <b>its numbers and
          claims belong to different rule eras</b>: the simulation tables in §4 describe the v1.2
          prototype, the balance proposals in §5 predate the canon, and several "open questions" have
          since been answered. Nothing here reflects the current game. For the live audit — current
          canon, current balance, the proposed next version — go to the{' '}
          <Link className="text-goldbright underline" to="/audit">Design Audit</Link> tab.
        </p>
      </Card>
      <P>
