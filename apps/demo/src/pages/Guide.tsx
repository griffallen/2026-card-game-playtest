  ...
  return (
    <div className="mx-auto max-w-3xl px-6 pb-24 pt-10 text-[15px]">
      ...
      <ul className="ml-5 mt-2 list-disc">
        ...
        <LI><B>The target always hits back</B> — exhausted or not. Solo, you eat its <B>full</B> power, so do the arithmetic both ways before a duel: <i>my power against their health, their power against my health.</i> But a <B>gang splits that blow</B>: the target's power pours across your unblocked attackers, the biggest threat first, felling as many as it can afford and no more. Numbers dull a big wall's teeth — three raiders into a 5-power wall lose two, not all three. Equal trades are for players who are ahead.</LI>
