...
const KEYWORDS: [string, string][] = [
  ['Guard', 'The bodyguard. When a single unit attacks, ONLY a Guard may step in front of the target — one Guard, taking the whole hit. And it never exhausts to block, in duels or gangs, so it can do it again and still take its own turn.'],
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 pb-24 pt-10 text-[15px]">
      ...
      <ul className="ml-5 list-disc">
        ...
        <LI><B>Block — the duel law.</B> A <B>single attacker cannot be blocked</B>, with one exception: a ready <B>Guard</B> in the zone may step in front of the target — <B>one Guard, taking the entire hit</B>. Attack with <B>two or more</B> and the defense opens up: the defender may pair any of their <B>ready units in that zone</B> onto your attackers — one-on-one, or ganging up — trading your gang's power for their choice of who gets stopped. The declared target may block its own attacker in a gang; blocking exhausts the blocker — except a Guard, who blocks for free.</LI>
