...
| **Tripwire** — touches engine primitives, `DECISIONS.md`, `rules-v1.2.md`, or changes what a card *does* (not just its stats) | Fable rules on the **design/behavior**; then **Opus implements the code** (not a ~150k Fable build) |
